...
- (void)drawRect:(CGRect)rect
{
    ...
    BOOL clockWise = true;
    //初始化一个路径
    UIBezierPath * roundpath = [UIBezierPath bezierPathWithArcCenter:CGPointMake(_startPoint.x,_startPoint.y) radius:radius startAngle:0 endAngle:M_PI * 2 clockwise:clockWise];
